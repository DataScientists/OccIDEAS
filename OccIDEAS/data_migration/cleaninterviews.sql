...
UPDATE occideas.Interview_Question SET type='Q_linkedmodule' where nodeClass is Null and type is null and name like '\_%';
UPDATE occideas.Interview_Question SET type='Q_linkedajsm' where nodeClass is Null and type is null;
