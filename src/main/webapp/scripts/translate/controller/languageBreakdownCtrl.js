            ...
            return ModulesService.getModuleLanguageBreakdown($scope.lang.id)
              .then(function(response) {
                if(response.status == '200') {
                  ...
                  vm.totalModuleCurrentCount = _.sumBy(modulestats, function(o) {
                    return o.current;
                  });
                  vm.totalModuleCount = _.sumBy(modulestats, function(o) {
                    return o.total;
                  });
                  return modulestats;
                }
            ...
            return FragmentsService.getFragmentLanguageBreakdown($scope.lang.id)
              .then(function(response) {
                if(response.status == '200') {
                  ...
                  vm.totalFragmentCurrentCount = _.sumBy(fragmentstats, function(o) {
                    return o.current;
                  });
                  vm.totalFragmentCount = _.sumBy(fragmentstats, function(o) {
                    return o.total;
                  });
