(function() {
    ...
    .directive("scopeQuestion", function() {
      return {
        template: '<ng-include src="\'scripts/questions/partials/moduleTree.html\'"></ng-include>' +
          ...
          '<ng-include src="\'scripts/questions/partials/rulesTemplateWrapper.html\'"></ng-include>' +
  ...
  function Config($stateProvider, $windowProvider, $rootScopeProvider, $stickyStateProvider) {
    ...
    $stateProvider.state({
      ...
      name: 'tabs.participantDetails',
      url: '/interview/:row/:startWithReferenceNumber',
      sticky: true,
      deepStateRedirect: true,
      authenticate: true,
      views: {
        'participantDetails@tabs': {
      ...
      views: {
        'participantMapping@tabs': {
          ...
          resolve: {
			...
			addingAddress: function($stateParams) {
